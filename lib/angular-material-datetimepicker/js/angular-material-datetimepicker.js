(function (moment) {
  ...
  var template = '<md-dialog class="dtp" layout="column" style="width: 300px;">'
    ...
    + '                <div class="dtp-actual-day" ng-show="picker.timeMode">Select</div>'
    ...
    + '            <div class="dtp-actual-maxtime" ng-if="picker.currentView === picker.VIEWS.MINUTE"> MINUTE </div>'
    + '            <div class="dtp-actual-maxtime" ng-if="picker.currentView === picker.VIEWS.HOUR"> HOUR </div>'
